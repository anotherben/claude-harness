...
# Blocks Read on source files >N lines using compiled policy when available.
...
echo "" >&2
echo "  1. mcp__cortex-engine__cortex_outline(file_path=\"...\") - list symbols" >&2
echo "  2. mcp__cortex-engine__cortex_read_symbol(file_path=\"...\", symbol_name=\"...\") - read one symbol" >&2
echo "  3. mcp__cortex-engine__cortex_read_symbols(specs=[...]) - batch read" >&2
echo "  4. mcp__cortex-engine__cortex_context(file_path=\"...\", symbol_name=\"...\") - symbol + imports" >&2
echo "  5. mcp__cortex-engine__cortex_find_symbol(query=\"...\") - search by name" >&2
echo "" >&2
...
echo "" >&2
echo "If results seem stale, run: mcp__cortex-engine__cortex_reindex()" >&2
exit 2
