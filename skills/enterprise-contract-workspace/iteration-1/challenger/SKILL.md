...
Any sibling without the correct guard becomes a postcondition. For complex features that create new files, also scan for existing code that will consume or interact with the new code — those existing consumers are the blast radius.
