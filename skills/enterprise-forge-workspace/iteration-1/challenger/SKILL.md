...
This matters because a bug found without a test is a bug that will return. The recycle rule ensures every defect discovered in adversarial testing gets permanent regression coverage.
